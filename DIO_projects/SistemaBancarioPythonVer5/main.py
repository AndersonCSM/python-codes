...
Nessa versão do projetos além dos arquivos serem reorganizados em projetos diferentes, o usuário precisa logar em uma 
conta para fazer movimentações bancárias, para isso é preciso seguir o passo a passo abaixo:
